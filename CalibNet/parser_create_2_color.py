...
parser.add_argument("path" , help = "path to dataset folder, should contain all _sync folders")
args = parser.parse_args()

# dataset_path = "/tmp/lidar_calibration_dataset/2011_09_26/"
...
for fn in folder_names:
    ...
    # img_source = ns(glob.glob(fn + "image_02/data/*.png"))
    # img_target = ns(glob.glob(fn + "image_01/data/*.png"))
