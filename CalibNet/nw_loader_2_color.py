...
# dataset = np.loadtxt("./dataset_with_colorimgs.txt", dtype = str)
# dataset = np.loadtxt("../dataset_with_colorimgs_final.txt", dtype = str)
dataset = np.loadtxt("../parsed_set.txt", dtype = str)
# dataset = np.loadtxt("./dataset_new.txt", dtype = str)
...
def train_load(p_no):
    ...
    for s_name, t_name, img_source_name, img_target_name, transform in tqdm(zip(source_file_names, target_file_names, source_image_names, target_image_names, transforms)):
        ...
        # warped_ip = np.float32(smc.imread(s_name))
        ...
        # target_ip = np.float32(smc.imread(t_name))
